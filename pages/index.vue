    ...
    <b-card>
      <b-container fluid>
        <b-row>
          ...
          <b-col>
            <b-carousel id="carousel-1" v-model="slide" :interval="90000" :controls="flag_carousel" :indicators="flag_carousel" background="#ababab" img-width="1024" img-height="550" style="text-shadow: 1px 1px 2px #333;" @sliding-start="onSlideStart">
              <b-carousel-slide v-if="flag_carousel" v-for="(item,index) in forecast" :key="index" :caption="item.temp+'°C'" :text="formatTempValue(item.temp_min)+'°C/'+formatTempValue(item.temp_max)+'°C'" style="width:100%; max-height:550px" :img-src="'/'+item.weather_main+'.jpg'">
